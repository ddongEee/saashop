...
const getConsumeSqsUrlInput = { 
  Name: consts.CONSUME_TARGET_SQS, 
};
const response1 = await ssmClient.send(new GetParameterCommand(getConsumeSqsUrlInput));
const fromSqsUrl = response1.Parameter.Value;
