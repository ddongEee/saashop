import { getResourceParameters, updateOrderStatus, sendMessage } from '../src/service/service.mjs'
import { Logger, middlewares, interceptor } from "@hdall/lambda";
import LOG_CONFIG from "../src/config/config.mjs";

import mockEvent from '../src/mockEvent.mjs';

// const QueueUrl = "https://sqsClient.us-east-1.amazonaws.com/577845268130/ksuyeon-test"
...
const handler = middlewares(lambdaHandler).use(interceptor(logger));
await handler(mockEvent.event, mockEvent.context);